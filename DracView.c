...
static LocationID findID (char *pastPlays, int turnNum) {
	...
	if (strcmp(abbrev, "HI") == 0 ||
        ...
        return findTrueLocation(pastPlays,indexOfLocation-ROUND_SIZE*2);        
    } else if (strcmp(abbrev, "D3") == 0) {        
        return findTrueLocation(pastPlays,
                                indexOfLocation-ROUND_SIZE*3);        
    } else if (strcmp(abbrev, "D4") == 0) {        
        return findTrueLocation(pastPlays,indexOfLocation-ROUND_SIZE*4);        
    } else if (strcmp(abbrev, "D5") == 0) {        
        return findTrueLocation(pastPlays,indexOfLocation-ROUND_SIZE*5);        
    } else {        
